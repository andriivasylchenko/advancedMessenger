...
function prepare(func,req,res,next) {
    loggerWrapper.getLogger().debug("req.headers = " + JSON.stringify(req.headers));
    var resHolder = {
        statusCode: 204,
        ...
        setHeader: function(key,value) {
            ...
            if (res.statusCode == 409) {
                res.setHeader(Constant.CONFLICT_HEADER, true);
            }
            res.end(body);
        }
    }

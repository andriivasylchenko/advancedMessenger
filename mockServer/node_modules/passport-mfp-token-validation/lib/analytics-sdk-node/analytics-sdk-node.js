...
module.exports = function init(serviceName, onErrorCallback) {
    ...
    var emitter = new AnalyticsEventEmitter(logger, utils, CONSTANT, onErrorCallback, optionalArguments);

    var environment = utils.getEnvironment(emitter, optionalArguments.settings, logger, process);
    ...
    var dataUsageProcessor = require('./data-usage-processor.js');

    emitter.setupEventBuffer(eventBufferFactory, serviceName, dataUsageProcessor, setInterval);
